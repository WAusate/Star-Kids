...
export default function KidsDashboard() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background">
      ...
      {/* Header */}
      <header className="relative bg-gradient-to-r from-blue-600/90 via-blue-500/80 to-blue-700/90 backdrop-blur-md h-20 md:h-24 px-6 z-20 shadow-xl border-b border-white/20 flex items-center gap-4">
